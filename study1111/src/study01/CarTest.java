	...
	public static void main(String[] args) {
		...
		for(int i =0; i<5; i++) {
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("뒤쪽 왼쪽 타이어를kumhooTire 교체");
				myCar.backLeft = new kumhooTire("뒤 왼쪽", 12);
				break;
			case 4:
				System.out.println("뒤쪽 오른쪽 타이어를 kumhooTire 교체");
				myCar.backRight = new kumhooTire("뒤 오른쪽", 12);
				break;
			}
			System.out.println("--------------------------");
		}
